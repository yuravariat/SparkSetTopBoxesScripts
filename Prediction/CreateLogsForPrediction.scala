...
/**
  ...
  */
object CreateLogsForPrediction {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val logs_path = List(base_path + "rawxml/FWM_20150531_R.pd.gz",
      base_path + "rawxml/FWM_20150601_R.pd.gz",
      base_path + "rawxml/FWM_20150602_R.pd.gz",
      base_path + "rawxml/FWM_20150603_R.pd.gz",
      base_path + "rawxml/FWM_20150604_R.pd.gz",
      base_path + "rawxml/FWM_20150605_R.pd.gz",
      base_path + "rawxml/FWM_20150606_R.pd.gz",
      base_path + "rawxml/FWM_20150607_R.pd.gz",
      base_path + "rawxml/FWM_20150608_R.pd.gz",
      base_path + "rawxml/FWM_20150609_R.pd.gz")
    ...
    for (i <- cities.indices) {
      ...
      val results_path = base_path + "y_for_prediction/logs/5_months/" + city_name + "-" +
